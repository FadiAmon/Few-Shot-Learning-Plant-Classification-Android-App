        ...
        Auth.createUserWithEmailAndPassword(email_input,password_input).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AddUser.this, "משתמש נוצר בהצלחה!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddUser.this, "משהו לא התסדר... אנא נסה לפתוח משתמש שנית"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
